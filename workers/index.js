...
async function purgeCache() {
    try {
        ...
        const packagesUrl = 'https://raw.githubusercontent.com/ErisPulse/ErisPulse-ModuleRepo/2x/packages.json';
        await cache.delete(new Request(packagesUrl));
        const mapUrl = 'https://raw.githubusercontent.com/ErisPulse/ErisPulse-ModuleRepo/1x/map.json';
