...
export const I18n = (function () {
  ...
  const messages = {
    "zh-CN": {
      ...
      "market.cli": "CLI 扩展",
      "market.filter.quick": "快速筛选",
      "market.filter.featured": "推荐",
      "market.filter.official": "官方",
      "market.filter.verified": "已验证",
      "market.filter.unverified": "未验证",
      "market.filter.category": "分类",
      "market.filter.tags": "标签",
      "market.filter.sdk": "我的 SDK 版本",
      "market.filter.sdk.any": "不限",
      "market.filter.sdk.hint": "选择你的 SDK 版本，只显示可在该版本上运行的组件",
      // 模块分类：后端只存编号，展示名按当前语言取（编号见 config.js MODULE_CATEGORIES）
      "category.tool": "工具",
      "category.fun": "娱乐",
      "category.admin": "管理",
      "category.notify": "通知",
      "category.ai": "AI",
      "category.platform": "平台对接",
      "category.analytics": "数据分析",
      // 卡片标签折叠：点开 +N 查看全部标签的悬浮面板
      "market.tags.all": "全部标签",
      "market.tags.more": "还有 {count} 个标签",
      "market.filter.sort": "排序",
      "market.sort.default": "默认排序",
      "market.sort.name": "按名称",
      "market.sort.newest": "最近提交",
      "market.filter.reset": "清除筛选",
      "market.filter.tagsMore": "展开全部标签",
      "market.filter.tagsLess": "收起标签",
      "market.summary": "共 {count} 个组件",
      "market.summary.filtered": "筛选出 {count} 个组件",
      "market.empty.filtered": "没有符合筛选条件的组件",
      "market.minSdkVersion": "最低 SDK 版本",
      "market.submittedAt": "提交时间",
      ...
      "submit.minSdkVersionAny": "不限制",
      "submit.minSdkVersionHint": "列表来自 PyPI 上 ErisPulse 的实时版本，选择模块支持的最低 SDK 版本",
      "submit.category": "模块分类",
      "submit.categoryHint": "分类会显示在卡片上；标签仍可自由填写",
      "submit.tags": "标签",
      "submit.tagsHint": "标签自由填写，中英文均可，不影响提交",
      "submit.tagsCommon": "常用标签：",
      "submit.categoryPlaceholder": "请选择模块分类",
    ...
    en: {
      ...
      "market.filter.quick": "Quick filters",
      "market.filter.featured": "Featured",
      "market.filter.official": "Official",
      "market.filter.verified": "Verified",
      "market.filter.unverified": "Unverified",
      "market.filter.category": "Category",
      "market.filter.tags": "Tags",
      "market.filter.sdk": "My SDK version",
      "market.filter.sdk.any": "Any",
      "market.filter.sdk.hint": "Pick your SDK version to see only components that run on it",
      "category.tool": "Tools",
      "category.fun": "Entertainment",
      "category.admin": "Management",
      "category.notify": "Notifications",
      "category.ai": "AI",
      "category.platform": "Platform Integration",
      "category.analytics": "Analytics",
      "market.tags.all": "All tags",
      "market.tags.more": "{count} more tags",
      "market.filter.sort": "Sort",
      "market.sort.default": "Default",
      "market.sort.name": "By name",
      "market.sort.newest": "Newest",
      "market.filter.reset": "Clear filters",
      "market.filter.tagsMore": "Show all tags",
      "market.filter.tagsLess": "Show fewer tags",
      "market.summary": "{count} components",
      "market.summary.filtered": "{count} matching components",
      "market.empty.filtered": "No components match your filters",
      "market.minSdkVersion": "Minimum SDK version",
      "market.submittedAt": "Submitted",
      ...
      "submit.minSdkVersionAny": "No minimum",
      "submit.minSdkVersionHint": "Live version list from ErisPulse on PyPI — pick the minimum SDK your module supports",
      "submit.category": "Category",
      "submit.categoryHint": "Shown as a badge on the card; tags stay free-form",
      "submit.tags": "Tags",
      "submit.tagsHint": "Free-form: any language works and it never blocks submission",
      "submit.tagsCommon": "Frequent tags:",
    ...
    "zh-TW": {
      ...
      "market.cli": "CLI 擴充",
      "market.filter.quick": "快速篩選",
      "market.filter.featured": "推薦",
      "market.filter.official": "官方",
      "market.filter.verified": "已驗證",
      "market.filter.unverified": "未驗證",
      "market.filter.category": "分類",
      "market.filter.tags": "標籤",
      "market.filter.sdk": "我的 SDK 版本",
      "market.filter.sdk.any": "不限",
      "market.filter.sdk.hint": "選擇你的 SDK 版本，只顯示可在該版本上執行的組件",
      "category.tool": "工具",
      "category.fun": "娛樂",
      "category.admin": "管理",
      "category.notify": "通知",
      "category.ai": "AI",
      "category.platform": "平台對接",
      "category.analytics": "資料分析",
      "market.tags.all": "全部標籤",
      "market.tags.more": "還有 {count} 個標籤",
      "market.filter.sort": "排序",
      "market.sort.default": "預設排序",
      "market.sort.name": "依名稱",
      "market.sort.newest": "最近提交",
      "market.filter.reset": "清除篩選",
      "market.filter.tagsMore": "展開全部標籤",
      "market.filter.tagsLess": "收起標籤",
      "market.summary": "共 {count} 個組件",
      "market.summary.filtered": "篩選出 {count} 個組件",
      "market.empty.filtered": "沒有符合篩選條件的組件",
      "market.minSdkVersion": "最低 SDK 版本",
      "market.submittedAt": "提交時間",
      ...
      "submit.minSdkVersion": "最低 SDK 版本",
      "submit.minSdkVersionAny": "不限",
      "submit.minSdkVersionHint": "清單取自 PyPI 上 ErisPulse 的即時版本，選擇模組支援的最低 SDK 版本",
      "submit.category": "模組分類",
      "submit.categoryHint": "分類會顯示在卡片上；標籤仍可自由填寫",
      "submit.tags": "標籤",
      "submit.tagsHint": "標籤自由填寫，中英文皆可，不影響提交",
      "submit.tagsCommon": "常用標籤：",
      "submit.categoryPlaceholder": "請選擇模組分類",
    ...
    ja: {
      ...
      "market.cli": "CLI拡張",
      "market.filter.quick": "クイックフィルタ",
      "market.filter.featured": "おすすめ",
      "market.filter.official": "公式",
      "market.filter.verified": "検証済み",
      "market.filter.unverified": "未確認",
      "market.filter.category": "カテゴリ",
      "market.filter.tags": "タグ",
      "market.filter.sdk": "自分の SDK バージョン",
      "market.filter.sdk.any": "指定なし",
      "market.filter.sdk.hint": "SDK バージョンを選ぶと、そのバージョンで動作するコンポーネントのみ表示します",
      "category.tool": "ツール",
      "category.fun": "エンタメ",
      "category.admin": "管理",
      "category.notify": "通知",
      "category.ai": "AI",
      "category.platform": "プラットフォーム連携",
      "category.analytics": "データ分析",
      "market.tags.all": "すべてのタグ",
      "market.tags.more": "他 {count} 件のタグ",
      "market.filter.sort": "並び替え",
      "market.sort.default": "デフォルト",
      "market.sort.name": "名前順",
      "market.sort.newest": "新着順",
      "market.filter.reset": "フィルタを解除",
      "market.filter.tagsMore": "すべてのタグを表示",
      "market.filter.tagsLess": "タグを折りたたむ",
      "market.summary": "全 {count} 件のコンポーネント",
      "market.summary.filtered": "{count} 件が該当",
      "market.empty.filtered": "条件に一致するコンポーネントがありません",
      "market.minSdkVersion": "最低 SDK バージョン",
      "market.submittedAt": "投稿日時",
      ...
      "submit.minSdkVersionAny": "指定なし",
      "submit.minSdkVersionHint": "PyPI 上の ErisPulse の最新バージョン一覧から選択（モジュールが対応する最小の SDK バージョン）",
      "submit.category": "カテゴリ",
      "submit.categoryHint": "カードにバッジとして表示されます。タグは自由入力です",
      "submit.tags": "タグ",
      "submit.tagsHint": "タグは自由入力（日本語・英語どちらも可）で、入力内容が原因で弾かれることはありません",
      "submit.tagsCommon": "よく使うタグ：",
      "submit.categoryPlaceholder": "カテゴリを選択",
    ...
    ru: {
      ...
      "market.cli": "CLI-расширения",
      "market.filter.quick": "Быстрые фильтры",
      "market.filter.featured": "Рекомендуемые",
      "market.filter.official": "Официальные",
      "market.filter.verified": "Проверенные",
      "market.filter.unverified": "Непроверенные",
      "market.filter.category": "Категория",
      "market.filter.tags": "Теги",
      "market.filter.sdk": "Моя версия SDK",
      "market.filter.sdk.any": "Любая",
      "market.filter.sdk.hint": "Выберите свою версию SDK, чтобы видеть только совместимые компоненты",
      "category.tool": "Инструменты",
      "category.fun": "Развлечения",
      "category.admin": "Управление",
      "category.notify": "Уведомления",
      "category.ai": "AI",
      "category.platform": "Интеграции",
      "category.analytics": "Аналитика",
      "market.tags.all": "Все теги",
      "market.tags.more": "ещё {count} тегов",
      "market.filter.sort": "Сортировка",
      "market.sort.default": "По умолчанию",
      "market.sort.name": "По названию",
      "market.sort.newest": "Сначала новые",
      "market.filter.reset": "Сбросить фильтры",
      "market.filter.tagsMore": "Показать все теги",
      "market.filter.tagsLess": "Свернуть теги",
      "market.summary": "Всего компонентов: {count}",
      "market.summary.filtered": "Найдено: {count}",
      "market.empty.filtered": "Нет компонентов, подходящих под фильтры",
      "market.minSdkVersion": "Минимальная версия SDK",
      "market.submittedAt": "Дата отправки",
      ...
      "submit.minSdkVersionAny": "Без ограничений",
      "submit.minSdkVersionHint": "Список берётся из актуальных версий ErisPulse на PyPI — минимальная поддерживаемая версия SDK",
      "submit.category": "Категория",
      "submit.categoryHint": "Показывается на карточке; теги можно задавать свободно",
      "submit.tags": "Теги",
      "submit.tagsHint": "Любые теги на любом языке — они не влияют на отправку",
      "submit.tagsCommon": "Частые теги:",
      "submit.categoryPlaceholder": "Выберите категорию",
