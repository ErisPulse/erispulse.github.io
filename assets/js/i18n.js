...
const I18n = (function () {
    ...
    const messages = {
        'zh-CN': {
            ...
            'manage.statusHidden': '已隐藏',
            'manage.hide': '隐藏',
            'manage.unhide': '取消隐藏',
            'manage.delete': '删除',
            'manage.confirmHide': '确定要隐藏模块 {name} 吗？',
            'manage.confirmUnhide': '确定要取消隐藏模块 {name} 吗？',
            'manage.confirmDelete': '确定要删除模块 {name} 吗？此操作不可撤销！',
            'manage.successHide': '模块已隐藏',
            'manage.successUnhide': '模块已取消隐藏',
        ...
        'en': {
            ...
            'manage.hide': 'Hide',
            'manage.unhide': 'Unhide',
            'manage.delete': 'Delete',
            'manage.confirmHide': 'Are you sure you want to hide module {name}?',
            'manage.confirmUnhide': 'Are you sure you want to unhide module {name}?',
            'manage.confirmDelete': 'Are you sure you want to delete module {name}? This cannot be undone!',
            'manage.successHide': 'Module hidden',
            'manage.successUnhide': 'Module unhidden',
        ...
        'zh-TW': {
            ...
            'manage.statusHidden': '已隱藏',
            'manage.hide': '隱藏',
            'manage.unhide': '取消隱藏',
            'manage.delete': '刪除',
            'manage.confirmHide': '確定要隱藏模組 {name} 嗎？',
            'manage.confirmUnhide': '確定要取消隱藏模組 {name} 嗎？',
            'manage.confirmDelete': '確定要刪除模組 {name} 嗎？此操作不可撤銷！',
            'manage.successHide': '模組已隱藏',
            'manage.successUnhide': '模組已取消隱藏',
