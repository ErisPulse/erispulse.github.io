...
const I18n = (function () {
    ...
    const messages = {
        'zh-CN': {
            ...
            'submit.typeCli': 'CLI 扩展 (CLI Extension)',
            'submit.name': '模块名称',
            ...
            'submit.official': '官方维护',
            'submit.submitBtn': '提交',
            'submit.successTitle': '提交成功!',
            'submit.successDesc': '您的模块已提交，等待管理员验证后将正式显示在模块市场中。',
        ...
        'en': {
            ...
            'submit.official': 'Official',
            'submit.submitBtn': 'Submit',
            'submit.successTitle': 'Submitted!',
            'submit.successDesc': 'Your module has been submitted. It will appear in the market after admin verification.',
        ...
        'zh-TW': {
            ...
            'submit.typeCli': 'CLI 擴展 (CLI Extension)',
            'submit.name': '模組名稱',
            ...
            'submit.official': '官方維護',
            'submit.submitBtn': '提交',
            'submit.successTitle': '提交成功!',
            'submit.successDesc': '您的模組已提交，等待管理員驗證後將正式顯示在模組市場中。',
