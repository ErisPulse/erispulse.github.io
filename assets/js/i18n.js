...
export const I18n = (function () {
  ...
  const messages = {
    "zh-CN": {
      ...
      "builder.scrollTop": "滚动到顶部",
      "builder.scrollBottom": "滚动到底部",
    ...
    en: {
      ...
      "builder.scrollTop": "Scroll to top",
      "builder.scrollBottom": "Scroll to bottom",
    ...
    "zh-TW": {
      ...
      "builder.scrollTop": "捲動到頂部",
      "builder.scrollBottom": "捲動到底部",
    ...
    ja: {
      ...
      "builder.confirmOk": "OK",
      "builder.scrollTop": "トップへ",
      "builder.scrollBottom": "ボトムへ",
    ...
    ru: {
      ...
      "builder.confirmOk": "OK",
      "builder.scrollTop": "Наверх",
      "builder.scrollBottom": "Вниз",
